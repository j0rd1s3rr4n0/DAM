...
public class Exercici10 {
	...
	public static void main(String[] args) {
		/*
		 * Demanar una nota numèrica al usuari i mostrar un text o un altre segons el rang de valors
		 * dins del qual es troba la nota:
		...
		double nota;
		System.out.print("Nota: ");nota=input.nextDouble();
